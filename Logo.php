...
$logo = mysqli_query($conn, "SELECT * FROM product WHERE kategory_id = 1");
...
?>
    ...
    <nav class="py-5 px-7 flex items-center justify-between sticky top-0 z-10" style="background-color: #E6DCFF;">
        ...
        <div class="flex gap-10 text-2xl" style="font-family: Poppins">
            <a href="Logo.php" class="font-bold colt lo mt-1" style="color: #B497FF">Logos</a>
    ...
    <div class="container mx-auto py-8">
        <h1 class="text-3xl font-bold mb-8" style="color:#B497FF; font-family:Poppins;">Discover Your Logo!</h1>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 justify-center">
            ...
            <div class="flex flex-col items-center">
                    ...
                    <p class="desc mb-4 text-center"  style="font-family:Poppins;"><?php echo $l['description']?></p>
